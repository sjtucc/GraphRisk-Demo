...
# Start GBase Error messages
CR_UNKNOWN_ERROR = u"Unknown GBase error"
CR_SOCKET_CREATE_ERROR = u"Can't create UNIX socket (%s)"
CR_CONNECTION_ERROR = u"Can't connect to local GBase server through socket '%-.100s' (%s)"
CR_CONN_HOST_ERROR = u"Can't connect to GBase server on '%-.100s' (%s)"
CR_IPSOCK_ERROR = u"Can't create TCP/IP socket (%s)"
CR_UNKNOWN_HOST = u"Unknown GBase server host '%-.100s' (%s)"
CR_SERVER_GONE_ERROR = u"GBase server has gone away"
