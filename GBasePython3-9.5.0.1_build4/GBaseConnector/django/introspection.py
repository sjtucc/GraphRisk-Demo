...
from GBaseConnector.GBaseConstants import FieldType
...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    def get_table_description(self, cursor, table_name):
        ...
        """
        json_constraints = {}
        if self.connection.gbase_is_mariadb and self.connection.features.can_introspect_json_field:
    ...
    def get_sequences(self, cursor, table_name, table_fields=()):
        for field_info in self.get_table_description(cursor, table_name):
            if 'auto_increment' in field_info.extra:
                # GBase allows only one auto-increment column per table.
    ...
    def get_indexes(self, cursor, table_name):
        ...
        for row in rows:
            ...
            if row[4] not in indexes:
                indexes[row[4]] = {'primary_key': False, '': False}
            # It's possible to have the  and PK constraints in
            # separate indexes.
            if row[2] == 'PRIMARY':
    ...
    def get_storage_engine(self, cursor, table_name):
        ...
        if not result:
            return self.connection.features._gbase_storage_engine
        return result[0]
    ...
    def get_constraints(self, cursor, table_name):
        ...
        if self.connection.features.can_introspect_check_constraints:
            ...
            if self.connection.gbase_is_mariadb:
                type_query = """
