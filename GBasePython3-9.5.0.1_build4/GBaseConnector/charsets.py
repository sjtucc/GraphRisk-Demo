...
_GBASE_VERSION = (8, 0, 17)

"""This module contains the GBase Server Character Sets"""

GBASE_CHARACTER_SETS = [
    ...
    None,
    None,
    ("ucs2", "ucs2_general_gbase500_ci", False),  # 159
    ...
    None,
    None,
    ("utf8", "utf8_general_gbase500_ci", False),  # 223
