"""Implements parser to parse GBase option files.
"""
...
from .GBaseConstants import DEFAULT_CONFIGURATION, CNX_POOL_ARGS
...
class GBaseOptionsParser(SafeConfigParser):  # pylint: disable=R0901
    """This class implements methods to parse GBase option files"""
